...
if roadmap:
    print(
        ...
        "- Typechecker-internal work in lib/typecheck.ml (most of the Phase "
        "62-72 arc: a new type_error, constraint/coherence/unification "
        "tightening) -> load harden-typechecker.\n"
        "- Cross-cutting items threading resolve/desugar/eval (e.g. Phase 63, "
...
if stdlib:
    print(
        ...
        "- A new native primitive (extern in eval.ml) -> load add-primitive.\n"
