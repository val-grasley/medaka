...
|   | **TOTAL gap events**                                      | ~~57~~ ~~32~~ ~~31~~ ~~34†~~ ~~30~~ ~~23~~ ~~17~~ ~~15~~ ~~13~~ ~~11~~ **8** | ~~2722~~ ~~2677~~ ~~2660~~ ~~2025~~ ~~1927~~ ~~1925~~ ~~1924~~ ~~1942‡~~ ~~888§~~ ~~560¶~~ ~~215~~ ~~88~~ ~~76~~ ~~61~~ ~~31~~ ~~23~~ ~~18~~ **10** (E15 shadowed-local methods `lt`/`gt`/`sub` 61→31; E16 `CVariantUpdate` 31→23; E17 extern-as-value eta-wrap 23→18; E18 shadowed-local constrained-fn `elem` → bare `CDict` 18→10). **Residual 10 = 6 `Arbitrary` unit-head (excluded from bootstrap, gap #12) + 2 `filter`@List no-impl + `max`/`min` (genuine generic default-method dispatch, deferred D3b).** |
