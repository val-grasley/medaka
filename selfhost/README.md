...
#   diff_selfhost_eval_bytecode.sh, diff_selfhost_eval_bytecode_modules.sh,
#   diff_selfhost_eval_bytecode_typed.sh, diff_selfhost_eval_bytecode_run.sh,
#   diff_selfhost_bytecode_selfproc.sh, diff_selfhost_bytecode_eval_dict.sh
