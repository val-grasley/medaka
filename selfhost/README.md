...
sh test/diff_selfhost_llvm.sh                 # Stage 2 §2.4 LLVM spike — emit→clang→link→run→diff, scalar + function + Bool/Float + ADT/match + closure/HOF + records/tuples/refs slices (31/31; needs clang)
