...
sh test/diff_selfhost_llvm_typed.sh           # Stage 2 §2.4 LLVM spike slice 6 — TYPED dispatch (CMethod RKey direct call + CDict/RDict if-chain); oracle = typed Core-IR tree-walker (3/3; needs clang)
