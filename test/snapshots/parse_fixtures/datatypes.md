...
(DImpl true "Debug" ((TyCon "Shape3")) () ((im "debug" ((PVar "__x")) (EMatch (EVar "__x") (arm (PCon "Disc" (PVar "__a0")) () (EBinOp "++" (ELit (LString "Disc ")) (EApp (EVar "debug") (EVar "__a0")))) (arm (PCon "Tri" (PVar "__a0") (PVar "__a1")) () (EBinOp "++" (EBinOp "++" (EBinOp "++" (ELit (LString "Tri ")) (EApp (EVar "debug") (EVar "__a0"))) (ELit (LString " "))) (EApp (EVar "debug") (EVar "__a1"))))))))
...
(DImpl true "Debug" ((TyCon "Shape4")) () ((im "debug" ((PVar "__x")) (EMatch (EVar "__x") (arm (PCon "Dot" (PVar "__a0")) () (EBinOp "++" (ELit (LString "Dot ")) (EApp (EVar "debug") (EVar "__a0")))) (arm (PCon "Seg" (PVar "__a0") (PVar "__a1")) () (EBinOp "++" (EBinOp "++" (EBinOp "++" (ELit (LString "Seg ")) (EApp (EVar "debug") (EVar "__a0"))) (ELit (LString " "))) (EApp (EVar "debug") (EVar "__a1"))))))))
(DData Private "Point" () ((variant "Point" (ConNamed (field "x" (TyCon "Int")) (field "y" (TyCon "Int"))))) ())
...
(DImpl true "Debug" ((TyCon "Shape3")) () ((im "debug" ((PVar "__x")) (EMatch (EVar "__x") (arm (PCon "Disc" (PVar "__a0")) () (EBinOp "++" (ELit (LString "Disc ")) (EApp (EMethodRef "debug") (EVar "__a0")))) (arm (PCon "Tri" (PVar "__a0") (PVar "__a1")) () (EBinOp "++" (EBinOp "++" (EBinOp "++" (ELit (LString "Tri ")) (EApp (EMethodRef "debug") (EVar "__a0"))) (ELit (LString " "))) (EApp (EMethodRef "debug") (EVar "__a1"))))))))
(DData Private "Shape4" () ((variant "Dot" (ConPos (TyCon "Int"))) (variant "Seg" (ConPos (TyCon "Int") (TyCon "Int")))) ())
...
(DImpl true "Debug" ((TyCon "Shape4")) () ((im "debug" ((PVar "__x")) (EMatch (EVar "__x") (arm (PCon "Dot" (PVar "__a0")) () (EBinOp "++" (ELit (LString "Dot ")) (EApp (EMethodRef "debug") (EVar "__a0")))) (arm (PCon "Seg" (PVar "__a0") (PVar "__a1")) () (EBinOp "++" (EBinOp "++" (EBinOp "++" (ELit (LString "Seg ")) (EApp (EMethodRef "debug") (EVar "__a0"))) (ELit (LString " "))) (EApp (EMethodRef "debug") (EVar "__a1"))))))))
(DData Private "Point" () ((variant "Point" (ConNamed (field "x" (TyCon "Int")) (field "y" (TyCon "Int"))))) ())
(DData Private "Tagged" () ((variant "Tagged" (ConNamed (field "label" (TyCon "Int"))))) ())
