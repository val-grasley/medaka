...
(DFunDef false "arrRange" () (ERangeArray (ELit (LInt 1)) (ELit (LInt 5)) false))
(DFunDef false "arrRangeIncl" () (ERangeArray (ELit (LInt 0)) (ELit (LInt 9)) true))
(DFunDef false "sliceIt" ((PVar "xs")) (EApp (EApp (EApp (EApp (EVar "sliceRange") (EVar "xs")) (ELit (LInt 1))) (ELit (LInt 3))) (ELit (LBool false))))
(DFunDef false "sliceInclIt" ((PVar "xs")) (EApp (EApp (EApp (EApp (EVar "sliceRange") (EVar "xs")) (ELit (LInt 1))) (ELit (LInt 3))) (ELit (LBool true))))
...
(DFunDef false "arrRange" () (ERangeArray (ELit (LInt 1)) (ELit (LInt 5)) false))
(DFunDef false "arrRangeIncl" () (ERangeArray (ELit (LInt 0)) (ELit (LInt 9)) true))
(DFunDef false "sliceIt" ((PVar "xs")) (EApp (EApp (EApp (EApp (EMethodRef "sliceRange") (EVar "xs")) (ELit (LInt 1))) (ELit (LInt 3))) (ELit (LBool false))))
(DFunDef false "sliceInclIt" ((PVar "xs")) (EApp (EApp (EApp (EApp (EMethodRef "sliceRange") (EVar "xs")) (ELit (LInt 1))) (ELit (LInt 3))) (ELit (LBool true))))
