...
-- stdlib `sortBy` is effect-POLYMORPHIC (`(a -> a -> <e> Ordering) -> …`), which
-- is exactly what the arraySort* prims need: their comparator is a Value closure
-- applied through `apply` (`<Mut | e>`).  List's instances live in `core`, so this
-- import drags in no new instance surface (AGENTS.md: near-free).
import list.{sortBy}
...
externBindings _ = [
  ...
  ("arraySortInPlaceBy", prim2M pArraySortInPlaceBy),
  ("arraySortBy", prim2M pArraySortBy),
  ("Ref", prim1 pRef),
...
-- arraySortInPlaceBy / arraySortBy : the comparator arrives as a Value CLOSURE,
-- so it has to be applied through `apply` (effect `<Mut | e>`) and CANNOT be
-- handed to the PURE host `arraySortInPlaceBy` extern — same reason
-- pArrayMakeWith rebuilds via a list instead of delegating.  So sort the element
-- list with the effect-polymorphic stdlib `sortBy` and write it back.
valueToOrdering : Value e -> Ordering
valueToOrdering (VCon "Lt" []) = Lt
valueToOrdering (VCon "Eq" []) = Eq
valueToOrdering (VCon "Gt" []) = Gt
valueToOrdering _ = panic "sort comparator: did not return an Ordering"

sortValues : Value e -> List (Value e) -> <Mut | e> List (Value e)
sortValues cmp vs = sortBy (a b => valueToOrdering (apply (apply cmp a) b)) vs

writeBackFrom : Array (Value e) -> Int -> List (Value e) -> <Mut | e> Unit
writeBackFrom _ _ [] = ()
writeBackFrom a i (v::rest) =
  let _ = arraySetUnsafe i v a
  writeBackFrom a (i + 1) rest

pArraySortInPlaceBy : Value e -> Value e -> <Mut | e> Value e
pArraySortInPlaceBy cmp (VArray a) =
  let _ = writeBackFrom a 0 (sortValues cmp (arrayToListG a))
  VUnit
pArraySortInPlaceBy _ _ = panic "arraySortInPlaceBy: not an Array"

pArraySortBy : Value e -> Value e -> <Mut | e> Value e
pArraySortBy cmp (VArray a) =
  VArray (arrayFromList (sortValues cmp (arrayToListG a)))
pArraySortBy _ _ = panic "arraySortBy: not an Array"
...
(DTypeSig false "valueToOrdering" (TyFun (TyApp (TyCon "Value") (TyVar "e")) (TyCon "Ordering")))
(DFunDef false "valueToOrdering" ((PCon "VCon" (PLit (LString "Lt")) (PList))) (EVar "Lt"))
(DFunDef false "valueToOrdering" ((PCon "VCon" (PLit (LString "Eq")) (PList))) (EVar "Eq"))
(DFunDef false "valueToOrdering" ((PCon "VCon" (PLit (LString "Gt")) (PList))) (EVar "Gt"))
(DFunDef false "valueToOrdering" (PWild) (EApp (EVar "panic") (ELit (LString "sort comparator: did not return an Ordering"))))
(DTypeSig false "sortValues" (TyFun (TyApp (TyCon "Value") (TyVar "e")) (TyFun (TyApp (TyCon "List") (TyApp (TyCon "Value") (TyVar "e"))) (TyEffect ("Mut") (Some "e") (TyApp (TyCon "List") (TyApp (TyCon "Value") (TyVar "e")))))))
(DFunDef false "sortValues" ((PVar "cmp") (PVar "vs")) (EApp (EApp (EVar "sortBy") (ELam ((PVar "a") (PVar "b")) (EApp (EVar "valueToOrdering") (EApp (EApp (EVar "apply") (EApp (EApp (EVar "apply") (EVar "cmp")) (EVar "a"))) (EVar "b"))))) (EVar "vs")))
(DTypeSig false "writeBackFrom" (TyFun (TyApp (TyCon "Array") (TyApp (TyCon "Value") (TyVar "e"))) (TyFun (TyCon "Int") (TyFun (TyApp (TyCon "List") (TyApp (TyCon "Value") (TyVar "e"))) (TyEffect ("Mut") (Some "e") (TyCon "Unit"))))))
(DFunDef false "writeBackFrom" (PWild PWild (PList)) (ELit LUnit))
(DFunDef false "writeBackFrom" ((PVar "a") (PVar "i") (PCons (PVar "v") (PVar "rest"))) (EBlock (DoLet false false PWild (EApp (EApp (EApp (EVar "arraySetUnsafe") (EVar "i")) (EVar "v")) (EVar "a"))) (DoExpr (EApp (EApp (EApp (EVar "writeBackFrom") (EVar "a")) (EBinOp "+" (EVar "i") (ELit (LInt 1)))) (EVar "rest")))))
(DTypeSig false "pArraySortInPlaceBy" (TyFun (TyApp (TyCon "Value") (TyVar "e")) (TyFun (TyApp (TyCon "Value") (TyVar "e")) (TyEffect ("Mut") (Some "e") (TyApp (TyCon "Value") (TyVar "e"))))))
(DFunDef false "pArraySortInPlaceBy" ((PVar "cmp") (PCon "VArray" (PVar "a"))) (EBlock (DoLet false false PWild (EApp (EApp (EApp (EVar "writeBackFrom") (EVar "a")) (ELit (LInt 0))) (EApp (EApp (EVar "sortValues") (EVar "cmp")) (EApp (EVar "arrayToListG") (EVar "a"))))) (DoExpr (EVar "VUnit"))))
(DFunDef false "pArraySortInPlaceBy" (PWild PWild) (EApp (EVar "panic") (ELit (LString "arraySortInPlaceBy: not an Array"))))
(DTypeSig false "pArraySortBy" (TyFun (TyApp (TyCon "Value") (TyVar "e")) (TyFun (TyApp (TyCon "Value") (TyVar "e")) (TyEffect ("Mut") (Some "e") (TyApp (TyCon "Value") (TyVar "e"))))))
(DFunDef false "pArraySortBy" ((PVar "cmp") (PCon "VArray" (PVar "a"))) (EApp (EVar "VArray") (EApp (EVar "arrayFromList") (EApp (EApp (EVar "sortValues") (EVar "cmp")) (EApp (EVar "arrayToListG") (EVar "a"))))))
(DFunDef false "pArraySortBy" (PWild PWild) (EApp (EVar "panic") (ELit (LString "arraySortBy: not an Array"))))
