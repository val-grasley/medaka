...
public export data Decl =
  ...
  -- `effect Net Prefix` (domain-carrying), `internal effect Mut` (purity-only,
  -- never granted/parameterized).  v2 Stage 2a: domain = Some "Prefix" or None.
  | DEffect Bool String (Option String) Bool
