...
clangLink cc rtC llPath outPath inputAbs tmpDir = match detectGC cc tmpDir
  ...
  Some (gcCflags, gcLibs) =>
    ...
    let clangArgs = [optFlag, "-pthread"] ++ gcSectionsCflags ++ gcCflags ++ [llPath, rtInput] ++ gcLibs ++ [sectionsLink, "-lm", "-o", outPath]
