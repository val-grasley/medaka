...
typesOf : List Decl -> List Decl -> <Mut> (String, Bool)
...
emitDiagSection : String -> String -> String -> <IO, Mut> Unit
emitDiagSection root name content = emitSectionTagged root name content True

emitSectionTagged : String -> String -> String -> Bool -> <IO, Mut> Unit
...
emitTypes : String -> List Decl -> List Decl -> <IO, Mut> Unit
...
export runSnapshotSupervisor : String -> SnapMode -> Bool -> Option String -> List String -> List String -> <IO, Mut, Panic> Bool
...
superviseChunks : String -> SnapMode -> Option String -> List Chunk -> <IO, Mut, Panic> List SnapResult
...
runChunk : String -> SnapMode -> Option String -> List String -> List String -> <IO, Mut, Panic> List SnapResult
runChunk _ _ _ _ [] = []
...
settle : String -> SnapMode -> Option String -> List String -> (String, List RunSec) -> <IO, Mut, Panic> SnapResult
settle root mode outDir sel (path, secs) =
  (path, settleVerdict root mode outDir sel path secs, False)

settleVerdict : String -> SnapMode -> Option String -> List String -> String -> List RunSec -> <IO, Mut, Panic> String
...
verdictMissing : SnapMode -> String -> List String -> List RunSec -> <IO, Mut, Panic> String
...
verdictExisting : SnapMode -> String -> List String -> List RunSec -> String -> <IO, Mut, Panic> String
...
(DTypeSig false "emitDiagSection" (TyFun (TyCon "String") (TyFun (TyCon "String") (TyFun (TyCon "String") (TyEffect ("IO" "Mut") None (TyCon "Unit"))))))
...
(DTypeSig false "emitSectionTagged" (TyFun (TyCon "String") (TyFun (TyCon "String") (TyFun (TyCon "String") (TyFun (TyCon "Bool") (TyEffect ("IO" "Mut") None (TyCon "Unit")))))))
...
(DTypeSig false "emitTypes" (TyFun (TyCon "String") (TyFun (TyApp (TyCon "List") (TyCon "Decl")) (TyFun (TyApp (TyCon "List") (TyCon "Decl")) (TyEffect ("IO" "Mut") None (TyCon "Unit"))))))
...
(DTypeSig true "runSnapshotSupervisor" (TyFun (TyCon "String") (TyFun (TyCon "SnapMode") (TyFun (TyCon "Bool") (TyFun (TyApp (TyCon "Option") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyEffect ("IO" "Mut" "Panic") None (TyCon "Bool")))))))))
...
(DTypeSig false "superviseChunks" (TyFun (TyCon "String") (TyFun (TyCon "SnapMode") (TyFun (TyApp (TyCon "Option") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "Chunk")) (TyEffect ("IO" "Mut" "Panic") None (TyApp (TyCon "List") (TyCon "SnapResult"))))))))
...
(DTypeSig false "runChunk" (TyFun (TyCon "String") (TyFun (TyCon "SnapMode") (TyFun (TyApp (TyCon "Option") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyEffect ("IO" "Mut" "Panic") None (TyApp (TyCon "List") (TyCon "SnapResult")))))))))
...
(DTypeSig false "settle" (TyFun (TyCon "String") (TyFun (TyCon "SnapMode") (TyFun (TyApp (TyCon "Option") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyFun (TyTuple (TyCon "String") (TyApp (TyCon "List") (TyCon "RunSec"))) (TyEffect ("IO" "Mut" "Panic") None (TyCon "SnapResult"))))))))
...
(DTypeSig false "settleVerdict" (TyFun (TyCon "String") (TyFun (TyCon "SnapMode") (TyFun (TyApp (TyCon "Option") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyFun (TyCon "String") (TyFun (TyApp (TyCon "List") (TyCon "RunSec")) (TyEffect ("IO" "Mut" "Panic") None (TyCon "String")))))))))
...
(DTypeSig false "verdictMissing" (TyFun (TyCon "SnapMode") (TyFun (TyCon "String") (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "RunSec")) (TyEffect ("IO" "Mut" "Panic") None (TyCon "String")))))))
...
(DTypeSig false "verdictExisting" (TyFun (TyCon "SnapMode") (TyFun (TyCon "String") (TyFun (TyApp (TyCon "List") (TyCon "String")) (TyFun (TyApp (TyCon "List") (TyCon "RunSec")) (TyFun (TyCon "String") (TyEffect ("IO" "Mut" "Panic") None (TyCon "String"))))))))
