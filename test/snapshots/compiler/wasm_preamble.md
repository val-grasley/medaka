...
floatRuntimeLines = [
  ...
  "  ;; floatToInt : boxed $float -> i64 (truncate toward zero, matching (int64)d).  #199:",
  "  ;; i64 result reboxes via $mdk_box_int so a large truncation (|x| > 2^30, up to 2^53)",
  "  ;; no longer overflows i32 (`float unrepresentable in integer range`) nor traps ref.i31.",
  "  (func $mdk_float_to_int (param $f (ref $float)) (result i64)",
  "    (i64.trunc_f64_s (struct.get $float 0 (local.get $f))))",
