...
stages=CORE_IR
# SOURCE
-- codepoint string indexing/slicing, int + char range patterns, backtick infix
sub x y = x - y
classify n = match n
  0..9 => "low"
  10..99 => "mid"
