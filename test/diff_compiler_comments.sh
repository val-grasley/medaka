...
# (compiler/entries/lex_comments_main.mdk: lex → collectComments) against the OCaml
...
# to `\n`).  This proves the compiler lexer surfaces the same comment channel
...
# NOT be captured).
#
# Usage:  sh test/diff_compiler_comments.sh [file.mdk ...]
