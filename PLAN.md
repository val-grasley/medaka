...
| **Capability-effects wedge (Phase 146)** | [`EFFECTS-CONFORMANCE-ROADMAP.md`](./EFFECTS-CONFORMANCE-ROADMAP.md) (v2 conformance) + [`CAPABILITY-EFFECTS.md`](./CAPABILITY-EFFECTS.md) §9 (lang) + [`CAPABILITY-PLATFORM.md`](./CAPABILITY-PLATFORM.md) §10 (product) | 🟡 in progress | gap-1 sound + gap-2 labels + wow-demo done; **WS-1 manifest realization (E1/E6) ✅ DONE (`41509f6`):** native `medaka check-policy` (bare `f9abda9` + parameter-level `a5b057a`) + `medaka manifest` TOML (`41509f6`). **WS-2 α scope-seeding (E3) ✅ DONE (`98bf22b`, both compilers).** **WS-3 `Set` domain (E2) ✅ DONE (`5a1d215`, native-only).** All fixpoint-gated. Next = WS-3b (param Env/Exec, unblocked), WS-4 (`Product`/structured Net), WS-5 (standing); Phase 146b |
