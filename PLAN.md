...
- **Still deferred:** C4 bare-Float-main auto-print (orthogonal nicety); B/monomorphization (the separate instance-DCE/backend-dispatch roadmap item — `project_backend_dispatch_strategy`, not a Float bug).
