...
| 🔴 Poly literal as a HOF arg → HOF spuriously `Num`-constrained w/ phantom dict param → runtime SIGTRAP | Compiler / language | 🔴 OPEN (2026-06-28) — orthogonal to CDict; literal-defaulting/constraint-inference interaction; memory `project_sqlite_review_batch` |
