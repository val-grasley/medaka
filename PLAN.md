...
| **Capability-effects wedge (Phase 146)** | [`EFFECTS-CONFORMANCE-ROADMAP.md`](./EFFECTS-CONFORMANCE-ROADMAP.md) (v2 conformance) + [`CAPABILITY-EFFECTS.md`](./CAPABILITY-EFFECTS.md) §9 (lang) + [`CAPABILITY-PLATFORM.md`](./CAPABILITY-PLATFORM.md) §10 (product) | 🟡 in progress | gap-1 sound + gap-2 labels + wow-demo done; **WS-1 capability-manifest realization ✅ DONE (2026-06-21, `41509f6`):** native `medaka check-policy` (bare-label `f9abda9` + parameter-level `a5b057a`) + `medaka manifest` TOML emission (`41509f6`), all fixpoint-gated. Next = WS-2 (α scope-seeding), WS-3 (`Set` domain)→WS-3b→WS-4 (`Product`/structured Net), WS-5 (standing); Phase 146b |
